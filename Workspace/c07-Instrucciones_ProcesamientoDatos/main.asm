...
; Operaciones lógicas
    ...
    ; AND (Logical AND)
        ...
        ANDS  R5, R2, R4            ; R5 = R2 and R4, update PSR
        ANDS  R6, R2, #0            ; R6 = R2 and 0, update PSR

    ; ORR (Logical OR)

        ORR   R7, R0, #0x80000000   ; R7 = R0 or 0x8000.0000
        ORRS  R8, R0, #0x80000000   ; R8 = R0 or 0x8000.0000, update PSR
...
; Operaciones de desplazamiento y rotación
    ...
    ; RRX (Rotate right with extend)
        ...
        RRX   R6, R0                ; R6 = R0 >> 1 (rotación extendida)
        RRX   R6, R6                ; R6 = R6 >> 1 (rotación extendida)
        RRX   R6, R6                ; R6 = R6 >> 1 (rotación extendida)
...
; Operaciones aritméticas
    ...
    ; ADD (Add)
        ...
        ADDS  R5, R0, R2            ; R5 = R0 + R2, update PSR
    ...
    ; SUB (Subtract)
        ...
        SUBS  R8, R3, R2            ; R8 = R3 - R2, update PSR
        SUBS  R8, R2, R3            ; R8 = R2 - R3, update PSR
    ...
    ; CMP (Compare)
        ...
        CMP   R0, #50               ; Update PSR (R0 - 50)
        CMP   R0, #40               ; Update PSR (R0 - 40)
        CMP   R0, #60               ; Update PSR (R0 - 60)
