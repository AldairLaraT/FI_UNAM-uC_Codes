...
#define ADC0_SSMUX3_R               (*((volatile uint32_t *)0x400380A0))                            /*  pp.1141     ADC Sample Sequence Input Multiplexer Select 3 */
...
#define ADC0_SSEMUX3_R              (*((volatile uint32_t *)0x400380B8))                            /*  pp.1146     ADC Sample Sequence Extended Input Multiplexer Select 3 */
